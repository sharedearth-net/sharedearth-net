...
$(document).ready(function(){ // This sets the opacity of the thumbs to fade down to 60% when the page loads
$(".button-holder-connect a").fadeTo("slow", 0.7);

$(".button-holder-connect a").hover(function(){
$(".button-holder-connect a").fadeTo("slow", 1); // This sets the opacity to 100% on hover
},function(){
$(".button-holder-connect a").fadeTo("slow", 0.7); // This sets the opacity back to 60% on mouseout
});
});
