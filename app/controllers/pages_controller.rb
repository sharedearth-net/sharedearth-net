class PagesController < ApplicationController
  ...
  def about
    about_layout = ((current_user.nil?  || !current_user.person.authorised_account) ? 'shared_earth' : 'application')
    render :layout => about_layout
  end

  def contribute
    contribute_layout = ((current_user.nil?  || !current_user.person.authorised_account) ? 'shared_earth' : 'application')
