class ActivityLog < ActiveRecord::Base
  ...
  def self.create_new_shareage_item_request_activity_log(item_request)
    event_code = ActivityLog.next_event_code
    ...
    ActivityLog.create!(
      ...
      :secondary_full_name => item_request.requester.name,
      :related => item_request,
      :event_type_id => EventType.new_shareage_item_request_gifter
    )
    ...
    ActivityLog.create!(
      ...
      :secondary_full_name => item_request.gifter.name,
      :related => item_request,
      :event_type_id => EventType.new_shareage_item_request_requester
    )
  end
