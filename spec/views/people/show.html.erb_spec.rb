...
describe "people/show.html.erb" do
  ...
  before do
    ...
    @person.users = [stub_model(User)]
    @person.users.first.stub!(:avatar).and_return("http://graph.facebook.com/basti/picture")
  ...
  it "shouldn't render a link to edit profile if viewing someone else's profile" do
    ...
    view.stub(:current_user).and_return(some_other_person.users.first)
    render
