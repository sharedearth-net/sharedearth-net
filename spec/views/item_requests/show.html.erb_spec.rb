...
describe "item_requests/show.html.erb" do
  ...
  it "renders accept/reject buttons for gifter if request hasn't been responded to" do
    ...
    render
    rendered.should have_selector("#accept_button")
    rendered.should have_selector("#reject_button")
    rendered.should_not have_selector("#complete_button")
  end
  ...
  it "renders complete button for gifter if request is accepted" do
    ...
    render
    rendered.should_not have_selector("#accept_button")
    rendered.should_not have_selector("#reject_button")
    rendered.should have_selector("#complete_button")
  end
