...
describe ItemsHelper do
  ...
  describe "truncate_item_type" do 
    it "should not truncate item types under 23 characters" do
      short_item_type = "shortstring"
      truncated_item_type = truncate_item_type(short_item_type)
    ...
    it "should truncate item types over 23 characters" do
      ...
      truncated_item_type = truncate_item_type(long_item_type)
  ...
  describe "truncate_item_name" do 
    it "should not truncate item names under 48 characters" do
      short_item_name = "shortname"
      truncated_item_name = truncate_item_name(short_item_name)
    ...
    it "should truncate item names over 48 characters" do
      ...
      truncated_item_name = truncate_item_name(long_item_name)
